...
namespace Kivotos
{
    public partial class NewImprt : Form
    {
        public NewImprt()
        {
            InitializeComponent();
        ...
        private void NewImprt_Load(object sender, EventArgs e)
        {
        ...
        {
            SqlDataAdapter sda = new SqlDataAdapter("Insert Into Storage(StrgCode,ImpCode,Description,ProdCode,Prod,Mtrl1Code,Mtrl1,Mtrl1Amnt,Mtrl2Code,Mtrl2,Mtrl2Amnt,Weight,DateTime,Details) Values('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text + "','" + textBox6.Text + "','" + textBox7.Text + "', '" + textBox8.Text + "', '" + textBox9.Text + "', '" + textBox10.Text + "', '" + textBox11.Text + "', '" + textBox12.Text + "', '" + textBox13.Text + "', '" + textBox14.Text + "')", con);
            DataTable dt = new DataTable();
            sda.Update(dt);
            sda.Fill(dt);
            dataGridView1.DataSource = dt;
